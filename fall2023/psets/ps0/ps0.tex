...
then calling \texttt{calculate\_sizes(T.root)} should modify  \treeT\ to be the following size-augmented tree:
 ...
 \includegraphics[scale=.175]{Fall23/Problem Sets and Exams/ps0/ps0_assets/p0_q1b_before.png}
 
 
 After:
 
  \includegraphics[scale=.225]{Fall23/Problem Sets and Exams/ps0/ps0_assets/p0_q1b_after.png}
