...
\fi
 ...
 \includegraphics[scale=.175]{Fall22/Problem Sets and Exams/ps0/ps0_assets/p0_q1_BT_before.png}
...
then calling \texttt{calculate\_sizes(T.root)} should modify  \treeT\ to be the following size-augmented tree:
 ...
 \includegraphics[scale=.175]{Fall22/Problem Sets and Exams/ps0/ps0_assets/p0_q1_BT_after.png}
 ...
 \includegraphics[scale=.175]{Fall22/Problem Sets and Exams/ps0/ps0_assets/p0_q1b_before.png}
 
 
 After:
 
  \includegraphics[scale=.225]{Fall22/Problem Sets and Exams/ps0/ps0_assets/p0_q1b_after.png}
